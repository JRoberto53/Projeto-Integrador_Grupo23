...
<body>
	...
	<form  action="usuarios/fornecedorAdd.php"  ID="form_perfil" name="form_cadastro"  method="post" STYLE="word-spacing: 0; text-indent: 0; margin: 0; " onSubmit="return VerificaCampox(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
    <tr style="border: 1px solid #CCC;">
      <td width="22" nowrap="nowrap">&nbsp;</td>
      <td height="20" colspan="2" nowrap="nowrap" class="menu002b"><strong>&nbsp;Perfil do Fornecedor</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="31" align="left" nowrap="nowrap" class="menu002"><label for="select">Prestação de Serviços de:</label>
        <select name="select" id="select" form="form_perfil">
          <option value="1">Ambientes</option>
          </select>
        <a href="?pg=ambientes" target="_self" class="form_button link_escuro">&nbsp;Adicionar >&nbsp; </a></td>
    </tr>
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
