...
<body>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
    <tr style="border: 1px solid #CCC;">
      ...
      <td height="20" colspan="2" nowrap="nowrap" class="menu002b"><strong>&nbsp;Perfil da Seguradora</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="31" align="left" nowrap="nowrap" class="menu002"><label for="select">Prestação de Serviços de:</label>
        ...
        <a href="?pg=seguros" target="_self" class="form_button link_escuro">&nbsp;Adicionar >&nbsp; </a></td>
    </tr>
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
