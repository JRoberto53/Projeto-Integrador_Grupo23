...
<body>
	...
	<form  action="usuarios/forncecedorAdd.php"  ID="form_perfil" name="form_cadastro"  method="post" STYLE="word-spacing: 0; text-indent: 0; margin: 0; " onSubmit="return VerificaCampox(this)">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
    <tr style="border: 1px solid #CCC;">
      <td width="22" nowrap="nowrap">&nbsp;</td>
      <td height="20" colspan="2" nowrap="nowrap" class="menu002b"><strong>&nbsp;Perfil da Financeira</strong></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">Razão Social </td>
    ...
    <tr>
      <td align="right">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">CNPJ </td>
      <td height="20" valign="bottom" class="menu002"><input name="usu_cnpj" type="text" class="campoB" id="usu_cnpj" form="form_perfil" accesskey="u" size="15" maxlength="20" value="<?php echo $usu_cnpj;?>"/></td>
    </tr>
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">Ins. Est. </td>
      <td height="20" valign="bottom" class="menu002"><input name="usu_iestadual" type="text" class="campoB" id="usu_iestadual" form="form_perfil" accesskey="u" size="15" maxlength="20" value="<?php echo $usu_iestadual;?>"/> 
        CEP 
    ...
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">Web Site</td>
      <td height="20" valign="bottom" class="menu002"><input name="usu_website" type="text" class="campoB" id="usu_website" form="form_perfil" accesskey="u" size="40" maxlength="50" value="<?php echo $usu_website;?>"/></td>
    </tr>
    <tr>
      <td width="22" align="right" nowrap="nowrap">&nbsp;</td>
      <td width="128" height="20" align="left" nowrap="nowrap" class="menu002">End/Rua </td>
    ...
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">N&uacute;mero </td>
      <td height="20" valign="bottom" class="menu002"><input name="usu_numero" type="text" class="campoB" id="usu_numero" form="form_perfil" accesskey="u" size="5" maxlength="10" value="<?php echo $usu_numero;?>"/> 
        Complemento 
        <input name="usu_complemento" type="text" class="campoB" id="usu_complemento" form="form_perfil" accesskey="u" size="15" maxlength="50" value="<?php echo $usu_complemento;?>"/></td>
    </tr>
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">Bairro </td>
    ...
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">Cidade </td>
      ...
      </span> <span class="menu002">
      <label for="usu_uf">UF</label>
      </span>
    ...
    <tr>
      <td width="22" align="right" nowrap="nowrap">&nbsp;</td>
      <td height="20" align="left" nowrap="nowrap" class="menu002">Tel. </td>
    ...
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
      <td height="31" align="left" nowrap="nowrap" class="menu002">&nbsp;</td>
      <td height="31" align="left" nowrap="nowrap" class="menu002"><label for="select">Prestação de Serviços de:</label>
        <select name="select" id="select" form="form_perfil">
          <option value="1">Financiamentos</option>
          </select>
        <a href="?pg=financiamentos" target="_self" class="form_button link_escuro">&nbsp;Adicionar >&nbsp; </a></td>
    </tr>
    <tr>
      <td align="right" nowrap="nowrap">&nbsp;</td>
    ...
    <tr>
      ...
      <td height="20" valign="bottom" class="menu002">
        ...
        <input form="form_perfil" type="hidden" name="usu_email" id="usu_email" accesskey="g" value="<?php echo((isset($_SESSION['usu_email'])) ? $_SESSION['usu_email'] : ''); ?>"/>
		  <input form="form_perfil" type="hidden" name="pg" id="pg" accesskey="g" value="<?php echo((isset($_GET['pg'])) ? $_GET['pg'] : ''); ?>"/>
        </td>
    </tr>
    <tr>
      <td nowrap="nowrap">&nbsp;</td>
